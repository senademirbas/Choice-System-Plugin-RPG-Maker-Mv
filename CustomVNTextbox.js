 ...
 * * @param Text X
 * @desc X coordinate for the start of the text.
 * @default 420
 *
 * @param Text Y
 * @desc Y coordinate for the start of the text.
 * @default 565
 *
 * @param Max Text Width
 * @desc Maximum width for text before wrapping to a new line.
 * @default 596
 *
 * @param --- Font Settings ---
 * * @param Font Size
 ...
 * @param --- Performance ---
 * * @param Preload List
 * @desc List of image filenames to load at startup to prevent lag. Separate with commas.
 * @default CyrusAngry, CyrusHappy, CyrusNeutral, LydiaHappy, Thoughts and Actions
 * @type string
 *
 * @param Preload Delay Frames
 * @desc Number of frames to wait between preloads (prevents freezing). 0 for instant.
 * @default 2
 * @type number
 * @min 0
 * @max 60
 ...
 * @desc Cache all used textbox images to prevent future lag. Recommended: ON
 * @default true
 * @type boolean
 *
 * @help
 * ============================================================================
 * SA_VNTextbox (Visual Novel Message System)
 * Version: 1.7 - Optimized Performance Edition
 * Author: SeninAdin
 * ============================================================================
 *
 * INTRODUCTION:
 * This plugin transforms the standard RPG Maker MV message system into a 
 * Visual Novel style interface with optimized performance and no lag.
 *
 * FEATURES:
 * 1. Custom Skins: Change the textbox background dynamically in-game.
 * 2. Optimized Preloading: Prevents lag by smart preloading and caching.
 * 3. Dynamic Cache System: Automatically caches used textboxes for future use.
 * 4. Frame-based Preloading: Prevents freezing during initial load.
 *
 * ============================================================================
 * PERFORMANCE OPTIMIZATIONS:
 * ============================================================================
 * - Smart preloading with configurable delay between frames
 * - Automatic caching of all used textbox images
 * - Background loading system
 * - Memory management for frequently used assets
 *
 * ============================================================================
 */
...
(function() {
    ...
    // PARAMETERS
    // =============================
    var parameters = PluginManager.parameters('SA_VNTextbox');
